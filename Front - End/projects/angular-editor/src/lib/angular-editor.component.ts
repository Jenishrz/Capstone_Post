...
import { AngularEditorService } from './Service/angular-editor.service';
//import { OptionComponent } from './option/option.component';
import { AngularEditorConfig, angularEditorConfig } from './Service/config';
import { isDefined } from './utils';
import 'select2';

import { Texteditor } from './Model/text';
import { TextpostService } from './Service/textpost.service';
...
value: Texteditor;
  ...
  getAllpost() {
    // this.tex.getAllPostDetails().subscribe(text => this.texList = text);
  }
  ...
  exec() {
    ...
    let userSelection: { focusNode: any; };
